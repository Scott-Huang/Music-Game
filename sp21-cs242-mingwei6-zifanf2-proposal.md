...
| Game Layout View | 5 | -1pt for the layout is not resizable <br /> -1pt for each missing components (circles, keys, background, music, ..., up to 3 pt) <br /> -1 pt for game interface cannot be displayed normally |
...
| Key Press Rendering | 3 | -3pt for no effects shown <br /> -1pt for effects are misformatted (not behave normally) |
| Game Play | 5 | -5pt for game not integrated at all <br />  -4pt for game cannot run at all <br /> -3pt for game cannot run normally <br /> -1pt for each small errors (up to 2pt) |
